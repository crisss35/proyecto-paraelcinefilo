...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }} ">
    ...
    <body>
        <header class="bg-slate-800 border-b-2 shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="flex items-center gap-3">
                    <a class="text-white font-bold uppercase" href="/noticias">NotiCines</a>
        ...
        <main class="container mx-auto mt-10">
            <h1 class="text-center font-black text-3xl mt-10 text-slate-800">
                @yield("titulo")
            </h1>
        ...
        <footer class="bg-slate-800 text-center text-white font-bold p-5 mt-12">
